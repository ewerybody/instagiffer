...
#define MyAppVersion GetEnv('INNOMyAppVersion')
#define BuildDir GetEnv('INNOBuildDir')
...
Source: "{#BuildDir}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
