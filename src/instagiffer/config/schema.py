...
class PathsConfig(BaseModel):
    ...
    working_dir: Path | None = Field(description='Custom working directory for temporary files')
...
class VideoConfig(BaseModel):
    ...
    maintain_aspect_ratio: bool = Field(description='Maintain aspect ratio when resizing')
...
class GifConfig(BaseModel):
    ...
    dither: Literal['none', 'floyd_steinberg', 'bayer'] = Field(description='Dithering algorithm')
...
class SettingsConfig(BaseModel):
    ...
    overwrite_gif: bool = Field(description='Overwrite existing GIF or create new numbered file')
    ...
    log_level: Literal['DEBUG', 'INFO', 'WARNING', 'ERROR'] = Field(description='Logging level')
